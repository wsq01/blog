---
title: 浏览器工作原理——页面性能优化
date: 2019-10-18 11:09:12
tags: [JS, 浏览器工作原理与实践]
categories: 
 - 前端
 - JS
...
{% asset_img img1.png 加载阶段渲染流水线 %}

观察上面这个渲染流水线，下面我们就先来分析下有哪些因素影响了页面加载速度这个问题。
...
如何减少关键资源的大小？可以压缩 CSS 和 JavaScript 资源，移除 HTML、CSS、JavaScript 文件中一些注释内容，也可以通过取消 CSS 或者 JavaScript 中关键资源的方式。
...
{% asset_img img3.png Performance 记录添加元素的执行过程 %}
...
{% asset_img img4.png 触发强制同步布局 Performance 图 %}
...
{% asset_img img5.png Performance 中关于布局抖动的表现 %}
